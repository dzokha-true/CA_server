...
Users can connect to the server via a socket, and can request to get their certificates based on an authentification. Users cannot connect to the server if they don't have credentials.
